     ...
     * solv,pdbtempl,tiltot)
c     ------------------------------------------------------------
c     Setermine borders of TM segments
c
      parameter (maxres=20000,maxsegm=900,maxlen=50,maxsub=60,
     *  maxat=150000)
c
...
c     do i=1,ntm
c        write (41,'(a1,2i4)') namtm(i),numtm(1,i),numtm(2,i)
c     end do
c
...
c
      parameter (maxsegm=900,maxlen=50)
c
